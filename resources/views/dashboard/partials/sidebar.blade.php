<aside class="navbar navbar-vertical navbar-expand-lg navbar-light">
  <div class="container-fluid">
    ...
    <h1 class="navbar-brand navbar-brand-autodark">
      <a href="{{ route('dashboard.letters.index') }}" class="text-decoration-none mt-2">
        Arsip Surat Desa
      </a>
    </h1>
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        <li class="nav-item {{ Request::is('dashboard/letters*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('dashboard.letters.index') }}">
        ...
        <li class="nav-item {{ Request::is('dashboard/letter-categories*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('dashboard.letter-categories.index') }}">
            <span class="nav-link-icon d-lg-inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="nav-item {{ Request::is('dashboard/about*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('dashboard.about.index') }}">
            <span class="nav-link-icon d-lg-inline-block">
